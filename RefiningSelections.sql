...
select title as titulo, pages as paginas from books order by pages limit 32,32;
select concat(title, ' ',released_year) as libros_recientes from books order by released_year desc limit 3;
